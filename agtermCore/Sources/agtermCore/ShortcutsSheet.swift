...
public enum ShortcutsSheet {
    ...
    private static let groups: [Group] = [
        Group(title: "Sessions", note: "A session is one shell in the sidebar.", rows: [
            ...
            Row(action: .newPrivateSession, label: "New private session — never saved, transcript erased on close"),
            ...
            Row(action: .togglePrivate, label: "Make the session private or public"),
        ...
        Group(title: "Panes & splits", note: "Two shells side by side in one session.", rows: [
            ...
            Row(action: .insertSecret, label: "Insert a secret from the keychain"),
        ...
        Group(title: "View", note: nil, rows: [
            ...
            Row(action: .showArtifacts, label: "Artifacts — files agents showed you"),
