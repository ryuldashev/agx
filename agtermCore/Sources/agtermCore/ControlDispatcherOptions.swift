...
/// The multi-argument inputs `ControlDispatcher` hands its `ControlActions` host, kept beside the dispatcher
/// rather than in it: they are plain value types with no routing in them.
