...
The same interface covers windows, splits, overlays, dashboards, HUDs, markdown reader panels, notifications, events, themes, and restoration. Every command is at [agterm.com/commands](https://agterm.com/commands).
