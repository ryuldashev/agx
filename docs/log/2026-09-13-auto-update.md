...
`reader-pane-2026-09-10`). ADR: `docs/decisions/0004-sparkle-auto-update.md`. Rule text:
...
- **Tests**: `AppUpdateTests`, `ControlDispatcherUpdateTests`, `UpdateCommandsTests`, protocol
  every-kind event test. Docs: ADR 0004, `FORK.md`, `site/commands.html#update`, skill reference/SKILL,
