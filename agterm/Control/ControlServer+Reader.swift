...
/// `ControlDispatcher+Reader`; this layer supplies the one thing agtermCore cannot resolve — whether the
/// file is there to read — and drives the store. The panel itself is `ReaderView`, built by the deck.
